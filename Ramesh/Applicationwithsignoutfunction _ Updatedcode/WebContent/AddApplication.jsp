		...
		<table>
			<tbody>
				<tr>
					...
					<c:set var="license_Id" value="${license_Id}"/>
					<c:out value="${license_Id}"></c:out>
					</td>
				</tr>
				<tr>
					...
					<c:set var="applicationname" value="${applicationname}"/>
				</td>
				</tr>
				...
				<tr>
					<td><input type="hidden" name="license_Id"value="${param.license_Id}" />
						<input type="hidden" name="applicationname"value="${param.applicationname}" />
