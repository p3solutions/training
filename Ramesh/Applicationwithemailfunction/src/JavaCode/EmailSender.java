		...
		String newline = System.lineSeparator();
	        ...
	        Session session = Session.getInstance(properties, new Authenticator() {
	            protected PasswordAuthentication getPasswordAuthentication() {
	                return new PasswordAuthentication("rameshinfotech777@gmail.com", "gjsw usar oppi fnhb");
	            }
	        });
	        ...
	        try {
	            ...
	            message.setText("Hi "+UserName+"!"+newline+" You Purchased the "+ApplicationName+"("+License_Id+") on "+date()+"Successfully. Thanks for Puchase this Application.  All the Best");
