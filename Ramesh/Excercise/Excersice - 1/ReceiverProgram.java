...
public class ReceiverProgram {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Receiver program is listening the given port " + receiverPort);
	    System.out.println("I am Ready to get the data from Sender");
    ...
    public static void processReceivedObject(Object receivedObject) {
        if (receivedObject instanceof String[]) {
            ...
            System.out.println("List of names received from sender :");
